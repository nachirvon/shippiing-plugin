...
class AMDSP_Online_Method extends AMDSP_Shipping_Method {
    ...
    public function init() {
        ...
        // Fixed line - Get the option value first, then apply intval with a fallback if needed
        $package_type_option = AMDSP_Option::get_section_option('settings.amdsp_default_package_type');
        $this->default_package_type = !empty($package_type_option) ? intval($package_type_option) : AMDSP_Admin::DEFAULT_PACKAGE_TYPE;
